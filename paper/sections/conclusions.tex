...
We have presented a systematic comparison of 21 turbulence closure models---4 data-driven architectures (MLP, TBNN, PI-TBNN, TBRF) in 3 size variants each, plus 9 classical RANS models (laminar baseline through full Reynolds stress model)---all implemented in a single GPU-accelerated incompressible Navier--Stokes solver and evaluated on the same training data, test cases, and hardware.
