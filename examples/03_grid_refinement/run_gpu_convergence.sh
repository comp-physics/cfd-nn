...
echo "  1. Coarse:     32 x 64     (max_steps:  50k)"
echo "  2. Medium:     64 x 128    (max_steps: 100k)"
echo "  3. Fine:      128 x 256    (max_steps: 300k)"
echo "  4. Very Fine: 256 x 512    (max_steps: 600k)"
echo ""
...
for grid_config in "${grids[@]}"; do
    ...
    echo ""
    echo "=========================================="
    echo "Running: $grid grid (max_steps=${grid_iters[$grid]})"
    echo "=========================================="
